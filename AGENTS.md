...
- **Order presentation:** seller-confirmed, in-memory order details behind the loopback UI boundary, with explicit fulfillment controls, capability-gated full and partial refunds, and an official-portal escape hatch; do not persist or log addresses, products, refund messages, or raw provider actions.
