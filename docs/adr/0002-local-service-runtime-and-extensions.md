...
- Implement a private Node.js application in strict TypeScript and compile it as ESM. ADR 0031 updates the supported and packaged runtime baseline to Node.js 24 LTS.
