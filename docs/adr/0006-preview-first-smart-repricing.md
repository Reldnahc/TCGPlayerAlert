...
- Default to delivered price, same-or-better condition, zero-cent adjustment, no price increases, and 100% of the lowest qualifying comparable. Use proportional rather than fixed-dollar gap thresholds: up to $1 uses the next listing at 20%; $1.01-$5 and $5.01-$25 use the next at 10%; $25.01-$100 skips for review at 8%; and above $100 skips at 5%. Require one comparable in the first tier, two through $25, and three above $25.
