...
- Card additions require an exact product-condition SKU and a merchandise profile. A quantity click prices and queues the card in one action; the inventory queue has its own enable switch.
